...
import { SiFacebook, SiX, SiInstagram, SiDiscord, SiYoutube } from 'react-icons/si';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div
                ...
                style={{ background: 'linear-gradient(135deg, #ff6b00, #e63946)' }}
              >
            ...
            <p className="text-sm leading-relaxed mb-6" style={{ color: '#6b6b88', maxWidth: '320px' }}>
              India's premier esports tournament platform for Free Fire and PUBG. Compete, win, and rise to the top.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm" style={{ color: '#6b6b88' }}>
        ...
        >
          ...
          <p className="text-xs flex items-center gap-1" style={{ color: '#4a4a60' }}>
            Built with{' '}
